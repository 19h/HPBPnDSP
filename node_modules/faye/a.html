...
Note that <a href="http://jquery.com/">jQuery-1.3.2.min.js</a>, <a href="http://code.google.com/p/ajaxsoft/wiki/xLazyLoader">jQuery-XLazyLoader.js</a> and <a href="http://jsbeautifier.org/">Beautify.min.js</a>  are already loaded in this example
	...
	<p>
		...
		<br />
		<input type="button" value="Load" onclick="var val = document.getElementById('jsToLoad').value;val ? load(val):alert('Please enter the url of your javascript file to be loaded');">
		<div id="loadLog">
		</div>
	</p>
	<p>
	...
	<script>
		...
		function extract(txt) {
			...
			document.getElementbyid('result').innerHTML = js_beautify(result, { indent_size: 4, indent_char: ' ', preserve_newlines: true, space_after_anon_function: true });
			return false;
		}
		function log(msg) {
			document.getElementbyid("#loadLog").innerHTM = msg + "<br/>" + document.getElementbyid("#loadLog").innerHTML;
		}
		var time;
		function load(data) {
			time = new Date().getTime();
                        var head= document.getElementsByTagName('head')[0];
                         ...
                         script.src= data + "?" + time;
                         return !void head.appendChild(script);
